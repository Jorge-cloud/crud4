...
<html lang="es">
  ...
  <body>
    ...
    <div class="container">
        ...
        <h1 class="mt-5">Lista de participantes</h1>
        <div class="text-right">
        <a href="<?php echo base_url(); ?>participantes/registro" class="btn btn-info">Añadir Nuevo</a> 
        </div>
                ...
                <?php $number=1; foreach($data as $key => $value): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?php echo base_url(); ?>participantes/delete/<?php echo $value->id_participante; ?>" class="btn btn-danger"><ion-icon name="trash-outline"></ion-icon></a>
